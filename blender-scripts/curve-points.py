#code comes from this page: http://blenderscripting.blogspot.com/2016/05/the-coordinates-of-curve-control-points.html
...
if obj.type == 'CURVE':
    for subcurve in obj.data.splines:
        ...
        # print nurbs curve coordinate points in an array
        if curvetype == 'NURBS':
        ...
        # print poly curve coordinate points in an array
        if curvetype == 'POLY':
            print("curve is closed:", subcurve.use_cyclic_u)
        ...
        # print bezier curve coordinate points in an array
        if curvetype == 'BEZIER':
            print("curve is closed:", subcurve.use_cyclic_u)
